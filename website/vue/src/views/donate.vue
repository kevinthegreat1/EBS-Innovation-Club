<template>
  <div id="wrapper">
    <label class="btc donate-crypto-box">
      ...
      <input class="coin-address" onclick="this.select()" readonly="readonly" spellcheck="false" type="text"
             value="1AiVpq67iaUhbe33rZTps1Dci4epsgCkvG"/></label><label class="eth donate-crypto-box">
    <div class="coin">
      <div class="coin-face">
        <svg height="10" viewBox="0 0 32 32" width="10" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <input class="coin-address" onclick="this.select()" readonly="readonly" spellcheck="false" type="text"
           value="0xed6F945c25350AD55781979B477567f18db94632"/></label><label class="ltc donate-crypto-box">
    <div class="coin">
      <div class="coin-face">
    ...
    <input class="coin-address" onclick="this.select()" readonly="readonly" spellcheck="false" type="text"
           value="Le9YNyVezEqBDWQZ7CrXJXoBdjt5FMNFbv"/></label>
  </div>
